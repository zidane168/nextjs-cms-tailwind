            ...
            <div className=" rounded-xl w-2/5 mx-auto border-black m12 p-4 shadow w-xs ">
                ...
                <div className="mt-2">
                    <label > Username: </label> 
                     <input className="px-2 rounded w-full" type="text" name="username" /> 
                </div>
            
                <div className="mt-4">
                     <label> Password: </label> 
                      <input className="px-2 rounded w-full" type="password" name="password" />  
                </div>  

                <div className="mt-2 text-center">
                    <button className="rounded bg-theme text-white p-2 px-6"> Login </button> 
                </div>
            </div>
        </div>
    )
