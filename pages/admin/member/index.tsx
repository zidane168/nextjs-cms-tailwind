        ...
        <div className="w-full mb-12 px-4">
          <div className="block w-full overflow-x-auto">
            ...
            <table className="items-center w-full bg-transparent border-collapse">
              <thead>
                <tr>
                  <th className="header">Project</th>
                  <th className="header">Budget</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="  align-middle text-xs whitespace-nowrap p-4 space-x-1">
                    <a
                      className="bg-sky-500 text-white p-2 rounded hover:bg-sky-700"
                      href="/admin/member/view/1"
                    >
                      <i className="fa-regular fa-eye"></i>
                    </a>
                    <a
                      className="bg-yellow-500 text-white p-2 rounded hover:bg-yellow-600"
                      href="/admin/member/edit/1"
                    >
                      {" "}
                      <i className="fa-solid fa-pen-to-square"></i>{" "}
                    </a>
                    <a className="bg-red-500  text-white p-2 rounded hover:bg-red-700">
                      {" "}
